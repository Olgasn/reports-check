...
- Формирование и редактировании списка используемых llm моделей и их свойств, включая как модели с доступом по сети посредством api, так локальные llm.
...
- Загрузка файлов отчетов студентов по лабораторной работе заданной дисциплины и трансформация их в текстовый формат; хранение и просмотр ранее загруженной информации.
